...
from ultralytics.nn.modules import *
from ultralytics.nn.modules.attention import SPPF_LSKA
from ultralytics.nn.modules.RFAconv import *
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    base_modules = frozenset(
        {
            ...
            C2fCIB,
            A2C2f,
            SPPF_LSKA,RFAConv, RFCAConv, RFCBAMConv,C2f_RFCBAMConv,CSPStage,
        }
    )
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        elif m in frozenset({Detect, WorldDetect, Segment, Pose, OBB, ImagePoolingAttn, Detect_DyHead, v10Detect}):
